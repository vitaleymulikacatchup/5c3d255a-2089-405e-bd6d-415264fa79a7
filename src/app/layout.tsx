...
export const metadata: Metadata = {
  ...
  description: "Discover artisan coffee, pastries, and a welcoming atmosphere at Brew Haven. Excellence in every cup since day one.",
  keywords: "specialty coffee, espresso, barista, coffee shop, cafe",
  openGraph: {
    title: "Brew Haven - Premium Specialty Coffee Shop",
